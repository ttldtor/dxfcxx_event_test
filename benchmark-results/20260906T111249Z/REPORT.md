...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| aggregation-stream-0 | stream-feed | optimal | 0.000 ms | 3 | 100.000% | 0.000 | 3.587 | 12.728 (12.056–13.387) | 19.094 | 13.668 | OK |
| aggregation-stream-10ms | stream-feed | optimal | 10.000 ms | 3 | 100.000% | 0.000 | 10.470 | 24.305 (24.145–25.281) | 31.574 | 26.093 | OK |
| aggregation-stream-1ms | stream-feed | optimal | 1.000 ms | 3 | 100.000% | 0.000 | 9.210 | 21.380 (20.635–21.851) | 34.490 | 24.383 | OK |
...
|---|---:|---:|---:|---:|---:|
| aggregation-stream-0 | 148542.500 | 0.536 | 1.208% | 0.000 | 0.000 |
| aggregation-stream-10ms | 148692.000 | 0.522 | 1.018% | 2621.000 | 0.000 |
| aggregation-stream-1ms | 148479.000 | 0.509 | 1.046% | 2864.000 | 0.000 |
...
|---|---:|---:|---:|---:|---:|
| aggregation-stream-0 | 148483.200 | 0.136 | 3.366% | 0.000 | 0.000 |
| aggregation-stream-10ms | 148710.000 | 0.134 | 3.398% | 1226.000 | 0.000 |
| aggregation-stream-1ms | 148265.600 | 0.134 | 3.388% | 605.000 | 0.000 |
